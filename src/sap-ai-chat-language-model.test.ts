...
vi.mock("./convert-to-sap-messages", () => ({
  convertToSAPMessages: vi.fn((messages: any[]) =>
...
describe("SAPAIChatLanguageModel", () => {
  ...
  describe("doGenerate", () => {
    ...
    it("should include tools in request when provided", async () => {
      ...
      expect(
        body.orchestration_config.module_configurations.templating_module_config
          .tools,
      ).toEqual([
        {
          type: "function",
  ...
  describe("request format", () => {
    it("should create correct orchestration config structure", async () => {
      ...
      expect(body.orchestration_config.module_configurations).toHaveProperty(
        "llm_module_config",
      );
      expect(body.orchestration_config.module_configurations).toHaveProperty(
      ...
      const llmConfig =
        body.orchestration_config.module_configurations.llm_module_config;
